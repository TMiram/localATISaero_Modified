...
//////////USUAL SETUP////////
  Serial.begin(9600);
  myport.begin(9600,SWSERIAL_8N1, RX_PORT, TX_PORT, false);
...
//DISPLAYING DATAS
  ...
  if (show_flag==0){
    ...
    tft.println("temperature: "); tft.print(int_temperature);  tft.println(" K.10");
  }
  else{
    ...
    tft.print("wind speed: "); tft.print(int_wind_speed); tft.println(" m/s");
    tft.println("wind direction: "); tft.print(int_wind_direction);  tft.println(" deg");
  }
//WRITING ON SERIAL
  ...
  show_flag=1-show_flag; // if 1 become 0 , if 0 become 1
